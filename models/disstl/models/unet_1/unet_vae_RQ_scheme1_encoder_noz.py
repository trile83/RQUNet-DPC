...
class UNet_VAE_RQ_scheme1_encoder_noz(nn.Module):
    def __init__(self, num_classes, segment, alpha, in_channels=3, depth=3, 
        ...
        Arguments:
            ...
            up_mode: string, type of upconvolution. Choices: 'transpose'
                ...
                upsampling.
        """
        super(UNet_VAE_RQ_scheme1_encoder_noz, self).__init__()
        ...
        for i in range(self.depth-1):
            self.up_convs.append(self.upsample)
            ins = outs
            outs = ins // 2
        ...
        size_lst = [32,16,8,4,2][:self.depth]
        Scales_quincunx = 2
        ...
        self.fc1 = nn.Linear(16384, latent_dim)
        self.fc2 = nn.Linear(16384, latent_dim)
        self.fc3 = nn.Linear(latent_dim, 16384)
        self.act = nn.ReLU()
