...
resamp_dir = '/home/geoint/tri/match-hls-sen'
hls_dir = '/home/geoint/tri/resampled_senegal_hls/mode'
...
for resamp_fl in resamp_lst:
    ...
    name_resamp = re.search(r'/match-hls-sen/HLS.S30.T28PFV.2017325T112351-(.*?).tif', resamp_fl).group(1)
    ...
    with rasterio.open(resamp_fl) as src, \
        ...
        out_fl_name = f'/home/geoint/tri/resampled_senegal_hls/trimmed/{name_resamp}.tif'
        with rasterio.open(
